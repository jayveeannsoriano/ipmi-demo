...
export const metadata: Metadata = {
  title: {
    default: "Ernest Maude International — IPMI",
    template: "%s | Ernest Maude International",
  },
  description:
    "International private medical insurance for expatriates, travellers and global businesses.",
}
